            ...
            </div>
            {
                posts.length > 0 ?
                    <div className='p-10'>
                        ...
                        <div className='flex gap-[50px] flex-wrap justify-start items-center px-10'>
                            {
                                posts?.map((post, index) => (
                                    <div className='border-neutral-500 border-[2px] rounded-lg relative mt-8' key={index}>
                                        ...
                                        <div className='py-10 pl-4'>
                                            ...
                                            <Button gradientDuoTone={'greenToBlue'} className='mt-4' onClick={() => {
                    ...
                    <div className='flex justify-center items-center h-[80vh]'>
                        <h1 className='text-3xl' hidden={loading}>You have no favorite posts</h1>
                    </div>
            }
        </section>
    )
