                ...
                <form onSubmit={handleSubmit}>
                    <div className='flex gap-5'>
                        <TextInput
                            ...
                            className='flex-auto'
                        />
                        <Select id='category' onChange={handleChange} className='flex-2'>
                    ...
                    <div className='flex'>
                        {
                            imageFileUrl ?
                                <img src={imageFileUrl} alt="image" className='w-72 h-72 mx-auto mt-4' />
                                :
                                null
                        }
                    </div>
                    <ReactQuill theme="snow" className='h-72 mt-4' placeholder='Write Something...' onChange={(value) => {
